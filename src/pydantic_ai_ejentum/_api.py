...
Internal module: not part of the public API. Used by the four harness
tools registered on :class:`pydantic_ai_ejentum.EjentumToolset`.
"""
...
def call_logic_api(
    ...
    calling tool is expected to return this string to the agent verbatim,
